...
{!! file_get_contents(module_path('shiftgenetator', 'resources/assets/js/core.js')); !!}
{!! file_get_contents(module_path('shiftgenetator', 'resources/assets/js/page.js')); !!}
{!! file_get_contents(module_path('shiftgenetator', 'resources/assets/js/main.js')); !!}

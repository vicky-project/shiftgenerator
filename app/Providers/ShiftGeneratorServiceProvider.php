...
namespace Modules\ShiftGenerator\Providers;
...
class ShiftGeneratorServiceProvider extends ServiceProvider
{
  use PathNamespace;

  protected string $name = 'ShiftGenerator';

  protected string $nameLower = 'shiftgenerator';
